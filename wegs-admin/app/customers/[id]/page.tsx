...
export default function CustomerDetailPage({ params }: { params: { id: string } }) {
    ...
    const handleGodModeLogin = () => {
        setIsLoading(true);
        setTimeout(() => setIsLoading(false), 2000); // Simulate network
        alert("Kullanıcı olarak giriş yapılıyor...");
    };
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-white shadow-sm ring-1 ring-gray-900/5 rounded-xl p-6">
                        <div className="flex items-center justify-between">
                            ...
                            <div className={cn("flex h-6 w-11 flex-none cursor-pointer rounded-full p-1 transition-colors duration-200 ease-in-out bg-green-500")}>
                                <span className={cn("translate-x-5 pointer-events-none inline-block h-4 w-4 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out")} />
                            </div>
                        </div>
